...
import DatePicker from 'react-datepicker'
                    ...
                    const fakeArray = [{id: 1, value: 1},{id: 2, value: 2},{id: 3, value: 3},{id: 4, value: 4}]
...
const defaultColumns = [
  ...
  },
  {
    ...
    headerName: 'Client',
    renderCell: ({ row }) => {
      // const { row.clientName, companyEmail } = row
  ...
  },
  {
    ...
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.dateEmission}</Typography>
  },
  {
    flex: 0.1,
    minWidth: 100,
