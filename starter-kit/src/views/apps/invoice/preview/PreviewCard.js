            ...
            <Grid item sm={6} xs={12} sx={{ mb: { sm: 0, xs: 4 } }}>
              <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <div>
                  ...
                  <Typography sx={{ color: 'text.secondary' }}>{data.clinic.coordonnee}</Typography>
                </div>
              </Box>
            </Grid>
        ...
        <CardContent sx={{ p: [`${theme.spacing(6)} !important`, `${theme.spacing(10)} !important`] }}>
          <Grid container>
            <Grid item xs={12} sm={6} sx={{ mb: { lg: 0, xs: 4 } }}>
              ...
              <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{data.client.clientName}</Typography>
              <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{data.client.company}</Typography>
              <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{data.client.clientAdress}</Typography>
              <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{data.client.tel}</Typography>
              <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{data.client.email}</Typography>
            </Grid>
                  ...
                  <Table>
                    <TableBody sx={{ '& .MuiTableCell-root': { py: `${theme.spacing(0.75)} !important` } }}>
                      ...
                      <TableRow>
                        ...
                        <MUITableCell>
                          <Typography sx={{ color: 'text.secondary' }}>{data.client.bank.bankName}</Typography>
                        </MUITableCell>
                      </TableRow>
                      <TableRow>
                        <MUITableCell>
                        ...
                        <MUITableCell>
                          <Typography sx={{ color: 'text.secondary' }}>{data.client.bank.bankCountry}</Typography>
                        </MUITableCell>
                      </TableRow>
                      <TableRow>
                        <MUITableCell>
                        ...
                        <MUITableCell>
                          <Typography sx={{ color: 'text.secondary' }}>{data.client.bank.bankCoordonnee}</Typography>
                        </MUITableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
        ...
        <TableContainer>
          <Table>
            ...
            <TableBody sx={{ '& .MuiTableCell-root': { fontSize: '1rem', py: `${theme.spacing(2.5)} !important` } }}>
              {
                  data.invoiceItems && data.invoiceItems.map((i,index) => {
                    return (
                      <TableRow key={index}>
                        <TableCell>{i.designation}</TableCell>
                        <TableCell>{i.description}</TableCell>
                        <TableCell>{i.coutUnitaire}</TableCell>
                        <TableCell>{i.quantite}</TableCell>
                        <TableCell>{i.totalunitaire}</TableCell>
                      </TableRow>
                    )
                  })
              }
          ...
          <Grid container>
            ...
            <Grid item xs={12} sm={5} lg={3} sx={{ mb: { sm: 0, xs: 4 }, order: { sm: 2, xs: 1 } }}>
              <CalcWrapper>
                ...
                <Typography sx={{ fontWeight: 500, color: 'text.secondary' }}>{data.montantTotal}</Typography>
              </CalcWrapper>
              <CalcWrapper>
