...
const AddCard = ({ getInvoice, toggleAddCustomerDrawer }) => {
  // ** Props
  ...
  const [houre, setHoure] = useState(1)
  const [description, setDescription] = useState('')
  const [total, setTotal] = useState(0)
  const [salesperson, setSalesperson] = useState('')
  const [salespersonComment, setSalespersonComment] = useState('')
  ...
  const handleAddItem = () => {
    ...
    const itemContructor = {
      ...
      quantite: houre,
      totalunitaire: houre * coutUnitaire,
      remise: 0,
      impots: 0
    }
    ...
    setTotal(total + itemContructor.totalunitaire)
  }
  ...
  useEffect(() => {
    ...
    const fff = {
      clinicId : entreprise && entreprise._id,
      clientId : clientsSelect && clientsSelect._id,
      id : factures && factures,
      dateEmission : issueDate && issueDate,
      dateEcheance : dueDate && dueDate,
      invoiceItems : invoiceItem && invoiceItem,
      montantTotal: total && total,
      balance : total && total,
      solder : false,
      clinic : entreprise && {
        clinicName: entreprise.name,
        clinicAdress: entreprise.adress,
        coordonnee: entreprise.coordonnee
      },
      client : clientsSelect && {
        clientName: clientsSelect.name,
        company: clientsSelect.company,
        clientAdress: clientsSelect.adress,
        tel: clientsSelect.tel,
        email: clientsSelect.email,
        bank: {
          bankName: clientsSelect.bank.bankName,
          bankCountry: clientsSelect.bank.bankCountry,
          bankCoordonnee: clientsSelect.bank.bankCoordonnee
        }
      },
      reglement: [],
      salesperson: salesperson && salesperson,
      salespersonComment: salespersonComment && salespersonComment,
      note: note && note
    }
    ...
    // })
  }, [invoiceItem, clientsSelect, salesperson, salespersonComment, issueDate, dueDate, note])
      ...
      <CardContent sx={{ p: [`${theme.spacing(6)} !important`, `${theme.spacing(10)} !important`] }}>
        <Grid container>
          <Grid item xs={12} sm={6} sx={{ mb: { lg: 0, xs: 4 } }}>
            ...
            <Select
              size='small'
              value={clientsSelect && clientsSelect.name}
            ...
            {clientsSelect !== null && clientsSelect !== undefined ? (
              <>
                ...
                <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{clientsSelect.adress}</Typography>
                <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{clientsSelect.tel}</Typography>
                <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{clientsSelect.email}</Typography>
              </>
            ) : null}
          </Grid>
                ...
                <Table>
                  <TableBody sx={{ '& .MuiTableCell-root': { py: `${theme.spacing(0.75)} !important` } }}>
                    <TableRow>
                      ...
                      <MUITableCell>
                        <Typography sx={{ fontWeight: 500, color: 'text.secondary' }}>{total} XOF</Typography>
                      </MUITableCell>
                    </TableRow>
                    <TableRow>
                      <MUITableCell>
                      ...
                      <MUITableCell>
                        <Typography sx={{ color: 'text.secondary' }}>
                          {clientsSelect && clientsSelect.bank.bankName && clientsSelect.bank.bankName}
                        </Typography>
                      </MUITableCell>
                    </TableRow>
                    <TableRow>
                      ...
                      <MUITableCell>
                        <Typography sx={{ color: 'text.secondary' }}>
                          {clientsSelect && clientsSelect.bank.bankCountry}
                        </Typography>
                      </MUITableCell>
                    </TableRow>
                    <TableRow>
                      ...
                      <MUITableCell>
                        <Typography sx={{ color: 'text.secondary' }}>
                          {clientsSelect && clientsSelect.bank.bankCoordonnee}
                        </Typography>
                      </MUITableCell>
                    </TableRow>
                  </TableBody>
                  ...
                  <RepeatingContent item xs={12}>
                    <Grid container sx={{ py: 4, width: '100%', pr: { lg: 0, xs: 4 } }}>
                      ...
                      <Grid item lg={2} md={1} xs={12} sx={{ px: 4, my: { lg: 0 }, mt: 2 }}>
                        ...
                        <Typography sx={{ color: 'text.secondary' }}>${item && item.totalunitaire}</Typography>
                      </Grid>
                    </Grid>
                    <InvoiceAction>
        ...
        <Grid container>
          <Grid item xs={12} sm={7} lg={9} sx={{ order: { sm: 1, xs: 2 } }}>
            ...
            <TextField
              size='small'
              sx={{ maxWidth: '300px' }}
              onChange={e => setSalespersonComment(e.target.value)}
...
// const AddCard = props => {
//   // ** Props
//   const { invoiceNumber, selectedClient, setSelectedClient, toggleAddCustomerDrawer } = props
...
//   const [idFactures, setIdFactures] = useState(null)
...
//   const [coutItem, setCoutItem] = useState(0)

//   const [factureItem, setFactureItem] = useState([])
//   // const [allFactureItem, setaAllFactureItem] = useState([])

//   useEffect(() => {
//     const fetechClinic = async () => {
//       const response = await fetch('http://localhost:4003/api/clinic')
...
//               </Box>
//               <div>
//                 <Typography sx={{ mb: 2, color: 'text.secondary' }}>{clinic && clinic.adress}</Typography>
//                 <Typography sx={{ mb: 2, color: 'text.secondary' }}>{clinic && clinic.coordonnee}</Typography>
//               </div>
//             </Box>
//           </Grid>
//           <Grid item xl={6} xs={12}>
...
//                   InputProps={{
//                     disabled: true,
//                     startAdornment: <InputAdornment position='start'>#{idFactures && idFactures}</InputAdornment>
//                   }}
//                 />
//               </Box>
//               <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
...
//                 <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{selectedClient.adress}</Typography>
//                 <Typography sx={{ mb: 1.5, color: 'text.secondary' }}>{selectedClient.tel}</Typography>
...
//                       </MUITableCell>
//                       <MUITableCell>
//                         <Typography sx={{ fontWeight: 500, color: 'text.secondary',background:'red' }}>$12,110.55</Typography>
//                       </MUITableCell>
//                     </TableRow>
//                     <TableRow>
//                       <MUITableCell>
...
//                       </MUITableCell>
//                       <MUITableCell>
//                         <Typography sx={{ color: 'text.secondary' }}>{selectedClient && selectedClient.bank.bankName}</Typography>
//                       </MUITableCell>
//                     </TableRow>
//                     <TableRow>
//                       <MUITableCell>
...
//                       </MUITableCell>
//                       <MUITableCell>
//                         <Typography sx={{ color: 'text.secondary' }}>{selectedClient && selectedClient.bank.bankCountry}</Typography>
//                       </MUITableCell>
//                     </TableRow>
//                     <TableRow>
//                       <MUITableCell>
...
//                       </MUITableCell>
//                       <MUITableCell>
//                         <Typography sx={{ color: 'text.secondary' }}>{selectedClient && selectedClient.bank.bankCoordonnee}</Typography>
//                       </MUITableCell>
//                     </TableRow>
//                   </TableBody>
//                 </Table>
...
//                           Item
//                         </Typography>
//                         <Select fullWidth size='small' defaultValue='Operation' value={designation} onChange={(e) => setDesignation(e.target.value)}>
//                           <MenuItem value='App Design'>App Design</MenuItem>
//                           <MenuItem value='App Customization'>App Customization</MenuItem>
//                           <MenuItem value='ABC Template'>ABC Template</MenuItem>
//                           <MenuItem value='App Development'>App Development</MenuItem>
...
//                           Price
//                         </Typography>
//                         <Typography sx={{ color: 'text.secondary' }}>${coutItem && coutItem}</Typography>
//                       </Grid>
//                     </Grid>
//                     <InvoiceAction>
//                       <IconButton size='small' onClick={deleteForm}>
...
//               const valeurItem = parseInt(coutUnitaire) * parseInt(quantite)
//               setCoutItem(valeurItem)
//               setCount(count + 1)
//               const fItem = {
//                 designation,
//                 description,
...
//                 valeurItem
//               }
//               setFactureItem([...factureItem, fItem])
//               // setaAllFactureItem([...allFactureItem, ])
//               setDesignation('')
//               setDescription('')
//               setCoutUnitaire(0)
//               setQuantite(1)
